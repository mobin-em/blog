        ...
        <div class="banner-container">
            <div class="flex h-full transition-transform duration-500" id="banner-slider">
                ...
                <div class="banner-slide min-w-full relative">
                    <img
                        src="{{ asset('storage/banner/photo-1629904853893-c2c8981a1dc5.jpg') }}"
                        alt="برنامه نویسی وب"
                        class="banner-image"
                        loading="eager"
                    >
                ...
                <div class="banner-slide min-w-full relative">
                    <img
                        src="{{ asset('storage/banner/photo-1517430816045-df4b7de11d1d.jpg') }}"
                        alt="هوش مصنوعی"
                        class="banner-image"
                        loading="eager"
                    >
                ...
                <div class="banner-slide min-w-full relative">
                    <img
                        src="{{ asset('storage/banner/photo-1551288049-bebda4e38f71.jpg') }}"
                        alt="داده کاوی"
                        class="banner-image"
                        loading="eager"
                    >
